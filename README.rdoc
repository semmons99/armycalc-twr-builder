...
The following commands can be used to cleanup generated files.
 rake clean
 rake clobber
...
'attrs' are the valid attributes a unit can have (space separated). Examples
"WS BS S T W I A LD SV FA SA RA". This should be mirrored in the CSVs.
...
'attrs' from the config file.
 ...
 name,description,category,min,max,baseCost,costPer
